...
import 'package:tutors/core/DI/register_modules.dart' as _i74;
...
import 'package:tutors/features/app/domain/usecases/sign_in_google_usecase.dart'
    as _i61;
import 'package:tutors/features/app/presentation/cubit/app_cubit.dart' as _i69;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i21.MyCourseRemoteDatasource>(
        () => _i21.MyCourseRemoteDatasourceImpl(
              gh<_i12.CouldFireStoreService>(),
              gh<_i11.AuthService>(),
            ));
    ...
    gh.lazySingleton<_i47.GetCreatedCourse>(
        () => _i47.GetCreatedCourse(gh<_i22.MyCourseRepository>()));
    gh.lazySingleton<_i48.GetCurrentUserAuthUsecase>(
        () => _i48.GetCurrentUserAuthUsecase(gh<_i43.AppRepository>()));
    gh.lazySingleton<_i49.GetCurrentUserDataUsecase>(
        () => _i49.GetCurrentUserDataUsecase(gh<_i19.HomeRepository>()));
    gh.lazySingleton<_i50.GetCurrentUserUsecase>(
        () => _i50.GetCurrentUserUsecase(gh<_i37.AccountRepository>()));
    gh.lazySingleton<_i51.GetProfileUsecase>(
        () => _i51.GetProfileUsecase(gh<_i37.AccountRepository>()));
    gh.lazySingleton<_i52.GetRegisteredCourseUsecase>(
        () => _i52.GetRegisteredCourseUsecase(gh<_i22.MyCourseRepository>()));
    gh.lazySingleton<_i53.GetUserUsecase>(
        () => _i53.GetUserUsecase(gh<_i43.AppRepository>()));
    gh.factory<_i54.HomeCubit>(
        () => _i54.HomeCubit(gh<_i49.GetCurrentUserDataUsecase>()));
    gh.factory<_i55.MyCourseCubit>(() => _i55.MyCourseCubit(
          gh<_i52.GetRegisteredCourseUsecase>(),
          gh<_i49.GetCurrentUserDataUsecase>(),
          gh<_i47.GetCreatedCourse>(),
        ));
    gh.lazySingleton<_i56.SaveUserDataUsecase>(
        () => _i56.SaveUserDataUsecase(gh<_i43.AppRepository>()));
    gh.lazySingleton<_i57.SettingLocalDatasource>(() =>
        _i57.SettingLocalDatasourceImpl(gh<_i26.SharedPreferenceService>()));
    gh.lazySingleton<_i58.SettingRepository>(() => _i59.SettingRepositoryImpl(
          gh<_i25.SettingRemoteDatasource>(),
          gh<_i57.SettingLocalDatasource>(),
        ));
    gh.factory<_i60.SignInCubit>(() => _i60.SignInCubit(
          gh<_i30.SignInUsecase>(),
          gh<_i53.GetUserUsecase>(),
        ));
    gh.lazySingleton<_i61.SignInWithGoogleUsecase>(
        () => _i61.SignInWithGoogleUsecase(gh<_i43.AppRepository>()));
    gh.lazySingleton<_i62.SignOutUsecase>(
        () => _i62.SignOutUsecase(gh<_i58.SettingRepository>()));
    gh.factory<_i63.SignUpCubit>(() => _i63.SignUpCubit(
          gh<_i34.SignUpUsecase>(),
          gh<_i35.UpdateUserRoleUsecase>(),
        ));
    gh.lazySingleton<_i64.UpdateEducationUsecase>(
        () => _i64.UpdateEducationUsecase(gh<_i37.AccountRepository>()));
    gh.lazySingleton<_i65.UpdateExperienceUsecase>(
        () => _i65.UpdateExperienceUsecase(gh<_i37.AccountRepository>()));
    gh.lazySingleton<_i66.UpdateUserProfile>(
        () => _i66.UpdateUserProfile(gh<_i37.AccountRepository>()));
    gh.lazySingleton<_i67.UploadImageUsecase>(
        () => _i67.UploadImageUsecase(gh<_i37.AccountRepository>()));
    gh.factory<_i68.AccountCubit>(() => _i68.AccountCubit(
          gh<_i50.GetCurrentUserUsecase>(),
          gh<_i6.ImagePicker>(),
          gh<_i67.UploadImageUsecase>(),
          gh<_i66.UpdateUserProfile>(),
          ...
          gh<_i51.GetProfileUsecase>(),
        ));
    gh.factory<_i69.AppCubit>(() => _i69.AppCubit(
          gh<_i48.GetCurrentUserAuthUsecase>(),
          gh<_i53.GetUserUsecase>(),
          gh<_i61.SignInWithGoogleUsecase>(),
          gh<_i56.SaveUserDataUsecase>(),
        ));
    gh.factory<_i70.CourseCubit>(() => _i70.CourseCubit(
          gh<_i49.GetCurrentUserDataUsecase>(),
    ...
    gh.lazySingleton<_i71.GetLanguageUsecase>(
        () => _i71.GetLanguageUsecase(gh<_i58.SettingRepository>()));
    gh.lazySingleton<_i72.SetLanguageUsecase>(
        () => _i72.SetLanguageUsecase(gh<_i58.SettingRepository>()));
    gh.factory<_i73.SettingCubit>(() => _i73.SettingCubit(
          gh<_i62.SignOutUsecase>(),
          gh<_i71.GetLanguageUsecase>(),
          gh<_i72.SetLanguageUsecase>(),
        ));
    return this;
  }
}
