...
import 'package:tutors/core/DI/register_modules.dart' as _i55;
...
import 'package:tutors/features/app/domain/usecases/sign_in_google_usecase.dart'
    as _i47;
import 'package:tutors/features/app/presentation/cubit/app_cubit.dart' as _i53;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i38.DeleteExperienceUsecase>(
        () => _i38.DeleteExperienceUsecase(gh<_i31.AccountRepository>()));
    gh.lazySingleton<_i39.GetCurrentUserAuthUsecase>(
        () => _i39.GetCurrentUserAuthUsecase(gh<_i36.AppRepository>()));
    gh.lazySingleton<_i40.GetCurrentUserDataUsecase>(
        () => _i40.GetCurrentUserDataUsecase(gh<_i14.HomeRepository>()));
    gh.lazySingleton<_i41.GetCurrentUserUsecase>(
        () => _i41.GetCurrentUserUsecase(gh<_i31.AccountRepository>()));
    gh.lazySingleton<_i42.GetUserUsecase>(
        () => _i42.GetUserUsecase(gh<_i36.AppRepository>()));
    gh.factory<_i43.HomeCubit>(
        () => _i43.HomeCubit(gh<_i40.GetCurrentUserDataUsecase>()));
    gh.lazySingleton<_i44.SaveUserDataUsecase>(
        () => _i44.SaveUserDataUsecase(gh<_i36.AppRepository>()));
    gh.factory<_i45.SettingCubit>(
        () => _i45.SettingCubit(gh<_i24.SignOutUsecase>()));
    ...
    gh.lazySingleton<_i47.SignInWithGoogleUsecase>(
        () => _i47.SignInWithGoogleUsecase(gh<_i36.AppRepository>()));
    gh.factory<_i48.SignUpCubit>(() => _i48.SignUpCubit(
          gh<_i28.SignUpUsecase>(),
          gh<_i29.UpdateUserRoleUsecase>(),
        ));
    gh.lazySingleton<_i49.UpdateExperienceUsecase>(
        () => _i49.UpdateExperienceUsecase(gh<_i31.AccountRepository>()));
    gh.lazySingleton<_i50.UpdateUserProfile>(
        () => _i50.UpdateUserProfile(gh<_i31.AccountRepository>()));
    gh.lazySingleton<_i51.UploadImageUsecase>(
        () => _i51.UploadImageUsecase(gh<_i31.AccountRepository>()));
    gh.factory<_i52.AccountCubit>(() => _i52.AccountCubit(
          gh<_i41.GetCurrentUserUsecase>(),
          gh<_i6.ImagePicker>(),
          gh<_i51.UploadImageUsecase>(),
          gh<_i50.UpdateUserProfile>(),
          gh<_i34.AddExperienceUsecase>(),
          gh<_i38.DeleteExperienceUsecase>(),
          gh<_i49.UpdateExperienceUsecase>(),
          gh<_i33.AddEducationUsecase>(),
        ));
    gh.factory<_i53.AppCubit>(() => _i53.AppCubit(
          gh<_i39.GetCurrentUserAuthUsecase>(),
          gh<_i42.GetUserUsecase>(),
          gh<_i47.SignInWithGoogleUsecase>(),
          gh<_i44.SaveUserDataUsecase>(),
        ));
    gh.factory<_i54.CourseCubit>(
        () => _i54.CourseCubit(gh<_i40.GetCurrentUserDataUsecase>()));
    return this;
  }
}
