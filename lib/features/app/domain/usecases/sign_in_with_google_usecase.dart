...
@lazySingleton
class SignInWithGoogleUseCase implements SynchronousUseCase<void, NoParams> {
  final AppRepository appRepository;

  SignInWithGoogleUseCase(this.appRepository);

  @override
  Future<Either<Failure, void>> call(NoParams params) async {
    return await appRepository.signInWithGoogle();
  }
}
